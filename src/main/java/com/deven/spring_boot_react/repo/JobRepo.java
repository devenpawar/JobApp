package com.deven.spring_boot_react.repo;
...
// jobs.add(new JobPost(1, "Java Developer", "Must have good experience in core
// Java and advanced Java", 2,
...
// jobs.add(new JobPost(3, "Data Scientist", "Strong background in machine
// learning and data analysis", 4,
...
// jobs.add(new JobPost(9, "Full Stack Developer", "Experience in both front-end
// and back-end development",
// 5, List.of("JavaScript", "Node.js", "React", "Spring", "MongoDB")));

// // Cloud Architect Job Post
// jobs.add(new JobPost(10, "Cloud Architect", "Design and implement cloud
// infrastructure solutions", 6,
// List.of("Cloud Computing", "AWS", "Azure", "Google Cloud")));

// // Job Post 11
// jobs.add(new JobPost(11, "Software Tester", "Ensure software quality through
...
// // Job Post 13
// jobs.add(new JobPost(13, "Business Analyst", "Analyze business processes and
// recommend improvements", 4,
...
// // Job Post 17
// jobs.add(new JobPost(17, "UX Researcher", "Conduct user research to inform
// the design process", 3,
// List.of("User Research", "Usability Testing", "Human-Computer
// Interaction")));
...
// // Job Post 19
// jobs.add(new JobPost(19, "Game Developer", "Create and optimize games for
// various platforms", 3,
